...
import { Typography, FlexContainer, useInteractiveProps, INTERACTIVE_PROP_TYPES, extractDOMPropsV2 } from '../../index.js';
      ...
      <div key={item.id} className={itemClasses}>
        ...
        <div className={headerClasses}>
          <button {...buttonProps}>
            ...
            {item.icon && (
              <FlexContainer className="accordion__item-icon">
                {renderIcon(item.icon)}
              </FlexContainer>
            )}
            
            {/* Título */}
            <Typography className="accordion__title" variant="body">
              {item.title}
            </Typography>
            
            {/* Subtítulo opcional */}
            {item.subtitle && (
              <Typography className="accordion__subtitle" variant="caption">
                {item.subtitle}
              </Typography>
            )}
            ...
            {/* Badge opcional */}
            {item.badge && (
              <Typography className="accordion__badge" variant="caption">
                {item.badge}
              </Typography>
            )}
            
            {/* Icono de expand/collapse */}
            <FlexContainer className={`accordion__toggle-icon ${iconRotation}`}>
