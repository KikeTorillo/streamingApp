...
const DynamicForm = ({
  ...
  const renderField = (field, index) => {
    ...
    // Para campos de tipo file (usando FileInput del sistema)
    if (fieldType === 'file') {
      return (
        <div key={index} className={fieldClasses.join(' ')}>
          <FileInput
    ...
    // NOTA: image-crop no está disponible en la versión de design-system
    // Usar FileInput básico para archivos de imagen
