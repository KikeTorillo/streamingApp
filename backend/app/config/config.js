const config = {
    ...
    subsDir: process.env.MINIO_SUBS_DIR,
    ...
    videoProcessingMode: process.env.VIDEO_PROCESSING_MODE || 'original',
    videoQualityProfile: process.env.VIDEO_QUALITY_PROFILE || 'standard'
}
